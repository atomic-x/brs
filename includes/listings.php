			...
			<div id="content">
				<div class="head">
                    ...
                    <div class="ui-widget cat-search" style="display:inline-block;padding:10px 0">
                      <input id="categorysearch" name="categorysearch" placeholder="Search Category" style="height:28px; width:186px; line-height:28px"> <a href="#" id="categorylinker" style="background:#840308; color:#ffffff; padding:5px;">Go</a>
                    </div>
                    <div style="clear:both"></div>
				</div>
